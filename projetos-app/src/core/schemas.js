...
// Mapa de cores por nome → classes Tailwind
export const COLOR_MAP = {
  gray:   { bg: 'bg-secondary',          text: 'text-muted-foreground', dot: 'bg-muted-foreground/50' },
  blue:   { bg: 'bg-blue-500/10',         text: 'text-blue-400',          dot: 'bg-blue-500' },
  green:  { bg: 'bg-green-500/10',        text: 'text-green-400',         dot: 'bg-green-500' },
  yellow: { bg: 'bg-yellow-500/10',       text: 'text-yellow-400',        dot: 'bg-yellow-500' },
