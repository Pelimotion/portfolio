...
const NAV_ITEMS = [
  ...
  { label: 'Calendario', href: '/projetos/calendario', icon: Calendar },
  { label: 'Financeiro', href: '/financeiro', icon: DollarSign },
  { label: 'CRM', href: '/crm', icon: Users },
]

export function PelimotionSidebar({ profile }: { profile: Profile | null }) {
  ...
  return (
    <Sidebar>
      <SidebarHeader className="p-4">
        <Link href="/projetos" className="text-lg font-bold">
          Pelimotion
        </Link>
      </SidebarHeader>
      <SidebarContent>
